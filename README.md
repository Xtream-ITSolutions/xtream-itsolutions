<div align="center">
  ...
  *Geschäftsführer & Head Dev*<br>
  ...
  <table align="center" width="80%">
    <tr>
      <td align="center" width="50%" valign="top">
        ...
        Hochverfügbares Webhosting & Domains<br>
        Dedizierte Server & VPS Lösungen<br>
        Cloud-Infrastruktur (AWS, Hetzner, GCP)
      </td>
      <td align="center" width="50%" valign="top">
        <h4>💻 Software Engineering</h4>
        Moderne Web-Apps (React, Next.js, Vue)<br>
        Skalierbare Backends (Node.js, Laravel, Python)<br>
    ...
    <tr>
      <td align="center" width="50%" valign="top">
        ...
        CI/CD Automatisierung & Docker/K8s<br>
        IT-Security Audits & Pentesting<br>
        24/7 Monitoring & System-Hardening
      </td>
      <td align="center" width="50%" valign="top">
        <h4>🎯 Consulting</h4>
  ...
  Wir setzen auf modernste Technologien, um skalierbare und performante Lösungen zu entwickeln.
